...
export const exportToExcel = (
  ...
  const complaintsData = data.complaints.map(complaint => ({
    ...
    "Resolved Date": complaint.resolvedAt ? new Date(complaint.resolvedAt).toLocaleDateString() : "Not resolved",
    "Assigned To": complaint.assignedUser?.fullName || "Unassigned",
    "Citizen Name": complaint.citizen?.fullName || "Guest",
