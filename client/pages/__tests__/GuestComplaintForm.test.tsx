...
describe('GuestComplaintForm', () => {
  ...
  describe('Multi-step form navigation', () => {
    it('should render step 1 (Details) by default', () => {
      ...
      expect(screen.getByText('Enter your personal details and complaint information')).toBeInTheDocument();
    ...
    it('should advance to step 2 when step 1 data is valid', async () => {
      ...
      const typeSelect = screen.getByRole('combobox', { name: /complaint type/i });
      ...
      fireEvent.change(screen.getByLabelText(/description/i), {
        target: { value: 'This is a detailed description of the water supply issue.' },
      });
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Specify the location where the issue occurred')).toBeInTheDocument();
      });
    });
    ...
    it('should advance to step 3 when step 2 data is valid', async () => {
      ...
      await waitFor(() => {
        const subZoneSelect = screen.getByRole('combobox', { name: /sub-zone/i });
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Optionally upload images to support your complaint')).toBeInTheDocument();
      });
    });
  ...
  describe('OTP verification', () => {
    it('should render OTP input when in OTP step', () => {
      const store = createTestStore({ submissionStep: 'otp', userEmail: 'test@example.com' });
      renderWithProviders(<GuestComplaintForm />, store);
    ...
    it('should show success page after OTP verification', () => {
      ...
      expect(screen.getByText('Welcome to Cochin Smart City!')).toBeInTheDocument();
