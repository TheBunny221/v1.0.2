...
const translations: Record<Language, Translation> = {
  ...
  hi: {
    ...
    guest: {
      ...
      guestSubmissionDescription:
        "अतिथि उपयोगकर्ताओं के लिए, हम आपकी शिकायत सबमिट करने से पहले सत्यापन के लिए आपके ईमेल पर एक OTP भेजेंगे। यह आपके सब���िशन की प्रामाणिकता सुनि��्चित करता है और आपको बाद में अपनी शिकायत को ट्रैक करने में सक्षम बनाता है।",
  ...
  ml: {
    ...
    auth: {
      ...
      email: "ഇമെയിൽ വിലാസം",
      password: "പാസ്വേഡ്",
      confirmPassword: "പാസ്വേഡ് സ്ഥിരീക��ിക്കുക",
    ...
    guest: {
      ...
      guestSubmissionDescription:
        "അതിഥി ഉപയോക്താക്കൾക്കായി, നിങ്ങളുടെ പരാതി സമർപ്പിക്കുന്നതിന് മുമ്പ് സ്ഥിരീകരണത്തിനായി ഞങ്ങൾ നിങ്ങളുടെ ഇമെയിലിലേക്ക് ഒരു OTP അയയ്ക്കും. ഇത് നിങ്ങളുടെ സമർപ്പണത്തിന്റെ ആധികാര���കത ഉറപ്പാക്കുകയും പിന്നീട് നിങ്ങളുടെ പരാതി ട്രാക്ക് ചെയ്യാ�� നിങ്ങളെ പ്രാപ്തമാക്കുകയും ചെയ്യുന്നു।",
    ...
    reports: {
      complaintReports: "പരാതി റ��പ്പോർട്ടുകൾ",
    ...
    messages: {
      ...
      complaintResolved: "പരാതി വിജയകരമാ��ി പരിഹരിച്ചു",
      ...
      logoutSuccessful: "ലോഗൗട്ട് വിജ���കരം",
