...
const validateStep2 = (formData: GuestComplaintData): ValidationErrors => {
  ...
  if (!formData.landmark || !formData.landmark.trim()) errors.landmark = "Landmark is required";
  if (!formData.address || !formData.address.trim()) errors.address = "Full address is required";
