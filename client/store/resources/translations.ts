...
export const hindiTranslations: Translation = {
  ...
  forms: {
    ...
    complaintSubmissionError: 'शिकायत जमा करने में असफल। कृपया पुनः प्रयास करें।',
...
export const malayalamTranslations: Translation = {
  ...
  forms: {
    ...
    complaintSubmissionError: 'പരാതി സമർപ്പിക്കുന്നതിൽ പരാജയപ്പെട്ടു. ദയവായി വീണ്ടും ശ്രമിക്കുക.',
  ...
  messages: {
    networkError: 'നെറ്റ്‌വർക്ക് കണക്ഷൻ പിശക്. ദയവായി നിങ്ങളുടെ ഇന്റർനെറ്റ് കണക്ഷൻ പരിശോധിക്കുക.',
    ...
    validationError: 'ദയവായി നിങ്ങളുടെ ഇൻപുട്ട് പരിശോധിച്ച് വീണ്ടും ശ്രമിക്കുക.',
