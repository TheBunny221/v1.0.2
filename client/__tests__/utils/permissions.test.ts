...
describe("Permission utilities", () => {
  ...
  describe("canViewComplaint", () => {
    ...
    test("should allow admin to view any complaint", () => {
      expect(canViewComplaint("ADMINISTRATOR", "any-user", mockComplaint)).toBe(
        true,
      );
    });
    ...
    test("should allow ward officer to view ward complaints", () => {
      expect(
        canViewComplaint("WARD_OFFICER", "user-3", mockComplaint, "ward-1"),
      ).toBe(true);
    });

    test("should not allow ward officer to view other ward complaints", () => {
      expect(
        canViewComplaint("WARD_OFFICER", "user-3", mockComplaint, "ward-2"),
      ).toBe(false);
    });
  });
  ...
  describe("canModifyComplaint", () => {
    ...
    test("should allow admin to modify any complaint", () => {
      expect(
        canModifyComplaint("ADMINISTRATOR", "any-user", mockComplaint),
      ).toBe(true);
    });
    ...
    test("should not allow citizen to modify resolved complaint", () => {
      ...
      expect(canModifyComplaint("CITIZEN", "user-1", resolvedComplaint)).toBe(
        false,
      );
    });
    ...
    test("should allow ward officer to modify ward complaints", () => {
      expect(
        canModifyComplaint("WARD_OFFICER", "user-3", mockComplaint, "ward-1"),
      ).toBe(true);
    });
  });
  ...
  describe("DataFilters", () => {
    ...
    test("should filter complaints for citizen to own only", () => {
      const filtered = DataFilters.filterComplaints(
        mockComplaints,
        "CITIZEN",
        "user-1",
      );
