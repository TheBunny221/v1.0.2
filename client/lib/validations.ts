...
export const registerSchema = z.object({
  ...
  role: z.enum(["CITIZEN", "WARD_OFFICER", "MAINTENANCE_TEAM", "ADMINISTRATOR"]).optional(),
...
export const complaintSchema = z.object({
  ...
  landmarks: z.string().max(100, "Landmarks must not exceed 100 characters").optional(),
});
...
export const updateComplaintSchema = z.object({
  status: z.enum(["registered", "assigned", "in_progress", "resolved", "closed", "reopened"]).optional(),
...
export const userManagementSchema = z.object({
  ...
  email: emailSchema,
  phoneNumber: phoneSchema.optional(),
  role: z.enum(["CITIZEN", "WARD_OFFICER", "MAINTENANCE_TEAM", "ADMINISTRATOR"]),
  wardId: z.string().optional(),
