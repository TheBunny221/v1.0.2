...
import { validateOtpRequest, validateComplaintData } from '../middleware/validation.js';
...
// @access  Public
router.post('/verify-otp', verifyOtpForGuest);
...
router.post('/submit-complaint', submitGuestComplaint);

// @desc    Track guest complaint
// @route   POST /api/guest/track-complaint
// @access  Public
router.post('/track-complaint', trackGuestComplaint);
