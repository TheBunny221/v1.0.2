...
const translations: Record<Language, Translation> = {
  en: {
    ...
    guest: {
      ...
      guestSubmissionDescription: 'For guest users, we\'ll send an OTP to your email for verification before submitting your complaint. This ensures the authenticity of your submission and enables you to track your complaint later.',
      welcomeBack: 'Welcome back',
      loginRequired: 'Login Required',
      loginRequiredDescription: 'Please login or register to submit complaints as a registered user.',
      enterOtp: 'Enter 6-digit OTP',
      resendOtp: 'Resend',
      otpExpires: 'OTP expires in',
      otpInstructions: 'We\'ve sent a 6-digit OTP to your email. Please enter it below to submit your complaint.',
  ...
  hi: {
    ...
    guest: {
      ...
      guestSubmissionDescription: 'अतिथि उपयोगकर्ताओं के लिए, हम आपकी शिकायत सबमिट करने से पहले सत्यापन के लिए आपके ईमेल पर एक OTP भेजेंगे। यह आपके सबमिशन की प्रामाणिकता सुनिश्चित करता है और आपको बाद में अपनी शिकायत को ट्रैक करने में सक्षम बनाता है।',
      welcomeBack: 'वापस स्वागत है',
      loginRequired: 'लॉगिन आवश्यक',
      loginRequiredDescription: 'पंजीकृत उपयोगकर्ता के रूप में शिकायत सबमिट करने के लिए कृपया लॉगिन करें या पंजीकरण करें।',
      enterOtp: '6-अंकीय OTP दर्ज करें',
      resendOtp: 'फिर से भेजें',
      otpExpires: 'OTP समाप्त होता है',
      otpInstructions: 'हमने आपके ईमेल पर 6-अंकीय OTP भेजा है। अपनी शिकायत ���बमिट करने के लिए कृपया इसे नीचे दर्ज करें।',
  ...
  ml: {
    ...
    guest: {
      ...
      guestSubmissionDescription: 'അതിഥി ഉപയോക്താക്കൾക്കായി, നിങ്ങളുടെ പരാതി സമർപ്പിക്കുന്നതിന് മുമ്പ് സ്ഥിരീകരണത്തിനായി ഞങ്ങൾ നിങ്ങളുടെ ഇമെയിലിലേക്ക് ഒരു OTP അയയ്ക്കും. ഇത് നിങ്ങളുടെ സമർപ്പണത്തിന്റെ ആധികാരികത ഉറപ്പാക്കുകയും പിന്നീട് നിങ്ങളുടെ പരാതി ട്രാക്ക് ചെയ്യാൻ നിങ്ങളെ പ്രാപ്തമാക്കുകയും ചെയ്യുന്നു।',
      welcomeBack: 'തിരികെ സ്വാഗതം',
      loginRequired: 'ലോഗിൻ ആവശ്യമാണ്',
      loginRequiredDescription: 'രജിസ്റ്റർ ചെയ്ത ഉപയോക്താവായി പരാതികൾ സമർപ്പിക്കാൻ ദ��വായി ലോഗിൻ ചെയ്യുക അല്ലെങ്കിൽ രജിസ്റ്റർ ചെയ്യുക.',
      enterOtp: '6-അക്ക OTP നൽകുക',
      resendOtp: 'വീണ്ടും അയയ്ക്കുക',
      otpExpires: 'OTP കാലാവധി',
      otpInstructions: 'ഞങ്ങൾ നിങ്ങളുടെ ഇമെയിലിലേക്ക് 6-അക്ക OTP അയച്ചിട്ടുണ്ട്. നിങ്ങളുടെ പരാതി സമർപ്പിക്കാൻ ദയവായി അത് താഴെ നൽകുക.',
