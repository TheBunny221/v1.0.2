...
const translations: Record<Language, Translation> = {
  ...
  hi: {
    ...
    guest: {
      ...
      otpInstructions: 'हमने आपके ईमेल पर 6-अंकीय OTP भेजा है। अपनी शिकायत सबमिट करने के लिए कृपया इसे नीचे दर्ज करें।',
    ...
    dashboard: {
      overview: 'अवलोकन',
      statistics: 'आंकड़े',
      recentComplaints: 'ह��ल की शिकायतें',
    ...
    messages: {
      ...
      statusUpdated: 'स्थिति सफलतापूर्वक अप���ेट की गई',
  ...
  ml: {
    ...
    reports: {
      ...
      performanceReports: 'പ്രകടന റിപ��പോർട്ടുകൾ',
