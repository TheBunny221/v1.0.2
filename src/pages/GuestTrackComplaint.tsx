...
const GuestTrackComplaint: React.FC = () => {
  ...
  const [trackedComplaint, setTrackedComplaint] =
    useState<TrackedComplaint | null>(null);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    <strong>Ward:</strong> {trackedComplaint.ward}
                  </p>
                  <p>
                    <strong>Area:</strong> {trackedComplaint.area}
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2">
                    <Badge variant="outline">
                      {trackedComplaint.assignedTo.name} -{" "}
        ...
        <CardContent className="pt-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              If you're unable to track your complaint or need assistance,
