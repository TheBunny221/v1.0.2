...
export const createDatabaseUnavailableResponse = (operation = "this operation") => {
  return {
    success: false,
    ...
    error: {
      ...
      message: "The database service is currently unavailable. Please check your database connection and try again.",
      suggestions: [
